...
// Hero images
const HERO_IMAGES = [heroKyro1, heroKyro2, heroKyro3];

// Descriptive alt text for each hero image
const HERO_IMAGE_ALTS = [
  "Kunal Mahato, frontend developer",
  "Kunal Mahato, freelance frontend developer",
  "Kunal Mahato, web developer",
];
...
export default function Hero() {
  ...
  const handleDefaultHover = useCallback(() => {
  ...
  // Choose a random transition on each image change
  useEffect(() => {
  ...
  // Get current transition variants
  const getTransitionVariants = () => {
    switch (transitionStyle) {
      case "center":
        return centerRevealVariants;

      case "stripes":
        return stripesVariants;

      default:
        return cornerVariants;
    }
  };
      ...
      <div className="relative min-h-screen md:h-screen flex flex-col md:block max-w-7xl mx-auto px-6 md:px-8 py-12 md:py-0">
        ...
        <div className="relative md:absolute z-10 left-0 md:left-[4%] lg:left-[6%] top-0 md:top-[18%] lg:top-[15%] w-full md:w-auto pt-8 md:pt-0">
          ...
          >
            ...
            <span className="block md:pl-[4vw] lg:pl-[5vw] bg-gradient-to-r from-[#3B82F6] to-[#F97316] bg-clip-text text-transparent md:text-white md:mix-blend-difference">
              MAHATO
            </span>
          </motion.h1>
          ...
          >
            <div
              className="w-12 h-px bg-gradient-to-r from-[#3B82F6] to-[#F97316] opacity-50"
              aria-hidden="true"
            />
        ...
        >
          <div className="relative group">
            {/* Image frame */}
            <div
              className="absolute -inset-4 border border-[#1a1a1a]/10 rounded-sm hidden md:block"
              aria-hidden="true"
            />

            <div
              className="absolute -inset-2 border border-[#1a1a1a]/5 rounded-sm hidden md:block"
              aria-hidden="true"
            />
              ...
              <AnimatePresence mode="wait">
                ...
                >
                  <img
                    ...
                    alt={HERO_IMAGE_ALTS[currentImageIndex]}
            ...
            {/* Image counter */}
            <div
              className="absolute -bottom-8 right-0 items-center gap-3 text-[#1a1a1a]/40 text-xs hidden md:flex"
              aria-hidden="true"
            >
              <span>—</span>
              ...
              <span className="w-4 h-px bg-[#1a1a1a]/20" />
          ...
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-8 md:gap-0">
            ...
            <div className="max-w-md">
              <p className="text-sm md:text-base text-[#1a1a1a]/70 leading-relaxed">
                Building modern, high-performing websites that help
                businesses grow and brands lead.
              </p>

              <p className="mt-2 text-xs md:text-sm font-medium text-[#1a1a1a]/70">
                <span className="text-[#3B82F6]">
                  React
                </span>{" "}
                •{" "}
            ...
            <div className="flex flex-col sm:flex-row gap-3 w-full sm:w-auto relative z-30">
              ...
              <a
                ...
                onMouseLeave={handleDefaultHover}
                aria-label="Start a project with Kunal Mahato"
              ...
              <a
                ...
                onMouseEnter={handleLinkHover}
                onMouseLeave={handleDefaultHover}
                aria-label="View Kunal Mahato's work and projects"
        ...
        >
          ...
          <div className="w-px h-12 bg-gradient-to-b from-[#3B82F6]/30 to-transparent" />
        </motion.div>
      </div>
    </section>
  );
